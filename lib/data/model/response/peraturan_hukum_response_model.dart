...
class PeraturanHukumResponseModel {
  final List<Item>? items;

  PeraturanHukumResponseModel({
    this.items,
  });

  PeraturanHukumResponseModel copyWith({
    List<Item>? items,
  }) =>
      PeraturanHukumResponseModel(
  ...
  factory PeraturanHukumResponseModel.fromRawJson(String str) =>
      PeraturanHukumResponseModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory PeraturanHukumResponseModel.fromJson(Map<String, dynamic> json) =>
      PeraturanHukumResponseModel(
