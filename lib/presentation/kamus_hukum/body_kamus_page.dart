...
class BodyKamusPage extends StatefulWidget {
  const BodyKamusPage({super.key});

  @override
  State<BodyKamusPage> createState() => _BodyKamusPageState();
}

class _BodyKamusPageState extends State<BodyKamusPage> {
  @override
