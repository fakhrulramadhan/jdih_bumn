            ...
            children: [
                    ...
                    ListMenuWidget(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const PutusanScreen()),
                          );
                        },
                    ...
                    ListMenuWidget(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const MonografiScreen()),
                          );
                        },
                    ...
                    ListMenuWidget(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const KamusHukumScreen()),
                          );
                        },
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: [
                    InfoGrafisWidgetNew(
                      text: "Prinsip Tata Kelola \nPerusahaan yang Baik \nBUMN",
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const InfografisScreen()),
                        );
                      },
                    ),
                    InfoGrafisWidgetNew(
